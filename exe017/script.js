// 17 - Uma empresa mandou uma lista contendo os números mensais de tudo o que ela faturou, e nosso trabalho é ajudá-los a criar um relatório que exiba em quantos meses eles tiveram o saldo negativo.
...
for (let i = 0; i < listaDeGanhos.length; i++) {
    if(listaDeGanhos[i] < 0){
        totalNegativos++;
        console.log("Mês: "+totalNegativos + "(" + listaDeGanhos[i]+ ")");
    }
